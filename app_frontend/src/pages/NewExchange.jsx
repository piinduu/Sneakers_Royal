...
function NewExchange() {
    ...
    const handleConfirm = () => {
        if (selectedSneaker) {
            navigate("/new-exchange/details", { state: { sneaker: selectedSneaker } }); // Redirige con el estado de la zapatilla seleccionada
        } else {
    ...
    return (
        <div className="max-w-screen-lg mx-auto p-6">
            <h1 className="text-3xl font-bold text-center mb-6">Poner anuncio de intercambio</h1>
            <p className="text-lg text-center mb-8">¿Qué artículo quieres intercambiar?</p>
            ...
            {selectedSneaker && (
                <div className="text-center">
                    <button
                        className="bg-accent text-white py-3 px-6 rounded text-lg hover:bg-muted"
